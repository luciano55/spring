...
public class FlickrController {
  ...
  private static final String FLICKR_API_KEY = "ece50efbbc96d3875706066e62d80b8f";

  @RequestMapping("flickr_search")
  public String flickrSearch(Model model, @RequestParam String search)
      throws UnsupportedEncodingException, RestClientException, URISyntaxException {

    String url = "https://api.flickr.com/services/rest/" + "?api_key=" + FLICKR_API_KEY + "&format=json"
